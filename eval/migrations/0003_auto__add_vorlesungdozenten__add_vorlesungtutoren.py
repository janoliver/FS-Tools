...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VorlesungDozenten'
        db.create_table('eval_vorlesungdozenten', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vorlesung', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eval.Vorlesung'])),
            ('dozent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eval.Personal'])),
            ('einverstanden', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('eval', ['VorlesungDozenten'])

        # Adding model 'VorlesungTutoren'
        db.create_table('eval_vorlesungtutoren', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vorlesung', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eval.Vorlesung'])),
            ('tutor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eval.Personal'])),
            ('einverstanden', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('eval', ['VorlesungTutoren'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'VorlesungDozenten'
        db.delete_table('eval_vorlesungdozenten')

        # Deleting model 'VorlesungTutoren'
        db.delete_table('eval_vorlesungtutoren')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 29, 14, 22, 36, 30438)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 29, 14, 22, 36, 30357)'}),
        ...
        'eval.vorlesung': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'dozenten': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'vorlesungen'", 'symmetrical': 'False', 'through': "orm['eval.VorlesungDozenten']", 'to': "orm['eval.Personal']"}),
            'fragebogen': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'vorlesungen'", 'to': "orm['eval.Fragebogen']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'tutoren': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'vorlesungen_tutor'", 'to': "orm['eval.Personal']", 'through': "orm['eval.VorlesungTutoren']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'vlu': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'vorlesungen'", 'to': "orm['eval.Vlu']"})
        },
        'eval.vorlesungdozenten': {
            'Meta': {'object_name': 'VorlesungDozenten'},
            'dozent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eval.Personal']"}),
            'einverstanden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'vorlesung': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eval.Vorlesung']"})
        },
        'eval.vorlesungtutoren': {
            'Meta': {'object_name': 'VorlesungTutoren'},
            'einverstanden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tutor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eval.Personal']"}),
            'vorlesung': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eval.Vorlesung']"})
        }
    }
