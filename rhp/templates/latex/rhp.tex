...
% auswertung
\BLOCK{for fragenset in vl.fragebogen.fragensets.prefetch_related()}
  \BLOCK{for frage in fragenset.fragen.prefetch_related()} 
    \BLOCK{if not frage.fragentyp.texttype and frage.total(vl) > 0}
      \Frage{\VAR{frage.text}}{\VAR{frage.total(vl)}}
      \BLOCK{- for option in frage.fragentyp.optionen.all() -}
        \BLOCK{- if loop.first -}
