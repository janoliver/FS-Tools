...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Umfrage.mindest_wahl'
        db.add_column('umfrage_umfrage', 'mindest_wahl', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Umfrage.mindest_wahl'
        db.delete_column('umfrage_umfrage', 'mindest_wahl')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 29, 13, 21, 41, 665789)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 29, 13, 21, 41, 665709)'}),
